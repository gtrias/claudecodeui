...
export const isGitConfigured = (): boolean => {
  try {
...
export const setGitConfig = (dir: string, name: string, email: string): void => {
  try {
...
export const getGitStatus = (dir: string): { modified: string[]; added: string[]; deleted: string[]; untracked: string[] } => {
...
export const getGitBranch = (dir: string): string => {
  try {
...
export const getGitRemoteUrl = (dir: string): string => {
  try {
