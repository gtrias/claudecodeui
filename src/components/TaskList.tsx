...
type SortBy = 'id' | 'title' | 'status' | 'priority' | 'updated';
...
interface TaskListProps {
  ...
  onTaskCreated?: () => void;
  onShowPRDEditor?: (prd?: PRDFile | null) => void;
  existingPRDs?: PRDFile[];
  onRefreshPRDs?: (showNotification?: boolean) => void;
}
...
const TaskList: React.FC<TaskListProps> = ({ 
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (showPRDDropdown && !(event.target as Element).closest('.relative')) {
