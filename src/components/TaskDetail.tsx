...
import { X, Flag, User, ArrowRight, CheckCircle, Circle, AlertCircle, Pause, Edit, Save, Copy, ChevronDown, ChevronRight, Clock, LucideIcon } from 'lucide-react';
import { cn } from '../lib/utils';
import TaskIndicator from './TaskIndicator';
import { api } from '../utils/api';
import { useTaskMaster } from '../contexts/TaskMasterContext';
import { TaskStatus, TaskPriority, Subtask } from './TaskCard';
...
interface TaskDetailProps {
  task: TaskDetailTask;
  onClose: () => void;
  onEdit?: (task: TaskDetailTask) => void;
...
const TaskDetail: React.FC<TaskDetailProps> = ({ 
  ...
  const [editedTask, setEditedTask] = useState<TaskDetailTask>(task || {} as TaskDetailTask);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updates: Partial<TaskDetailTask> = {};
