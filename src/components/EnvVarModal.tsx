        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:text-white font-mono text-sm"
              disabled={isSaving}
            />
          ...
          <div>
            ...
            <div className="relative">
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-primary dark:bg-gray-700 dark:text-white font-mono text-sm pr-20"
                disabled={isSaving}
              />
