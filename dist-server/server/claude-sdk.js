...
// Abort a session
export function abortClaudeSDKSession(sessionId) {
...
// Query Claude SDK
export async function queryClaudeSDK(project, message, model, cwd) {
...
export { activeSessions, pendingToolApprovals, TOOL_APPROVAL_TIMEOUT_MS, createRequestId, waitForToolApproval, };
