...
const TaskMasterContext = createContext(undefined);
...
export const TaskMasterProvider = ({ children }) => {
    ...
    const refreshTasks = useCallback(async () => {
        ...
        try {
            ...
            const nextTask = data.tasks?.find((task) => task.status === 'pending' || task.status === 'in-progress') || null;
    ...
    return (_jsx(TaskMasterContext.Provider, { value: contextValue, children: children }));
};
