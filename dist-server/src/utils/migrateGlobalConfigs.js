 ...
 */
export function migrateGlobalToProjectSpecific(projectPath) {
    try {
        ...
        const projectConfig = {
            ...
            timestamp: Date.now(),
            activeProvider: globalSettings.provider,
            models: {
 ...
 */
export function migrateAllGlobalProjects(projects) {
    const results = {
        success: 0,
        failed: 0,
        skipped: 0,
 ...
 */
export function forceRemigration(projects) {
 ...
 */
export function rollbackMigration(projects) {
